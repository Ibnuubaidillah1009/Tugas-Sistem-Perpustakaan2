    ...
    <div class="max-w-md w-full space-y-8">
        ...
        <form class="mt-8 space-y-6" method="POST" action="{{ route('register') }}">
            ...
            <div class="space-y-4">
                ...
                <div>
                    <label for="role" class="block text-sm font-medium text-gray-700">Jenis Akun</label>
                    <select id="role" name="role" required 
                            class="mt-1 block w-full px-3 py-2 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-primary-500 focus:border-primary-500 sm:text-sm @error('role') border-red-500 @enderror">
