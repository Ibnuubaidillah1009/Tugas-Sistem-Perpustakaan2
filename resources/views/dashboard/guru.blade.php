...
<div class="space-y-6">
    <!-- Welcome Section -->
    <div class="bg-gradient-to-br from-blue-600 via-purple-600 to-indigo-700 rounded-xl shadow-xl overflow-hidden">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-6">
                    ...
                    <div>
                        ...
                        <div class="mt-3 flex items-center space-x-4 text-sm text-blue-200">
                ...
                <div class="hidden md:block">
                    <div class="text-right">
                        <div class="text-blue-200 text-sm mb-1">Dashboard Guru</div>
            ...
            <div class="px-6 py-5 sm:p-6">
                ...
                @if($my_borrowings->count() > 0)
                    <div class="mt-6 pt-4 border-t border-gray-200">
                        <a href="{{ route('guru.borrowings.index') }}" class="inline-flex items-center text-sm font-medium text-purple-600 hover:text-purple-500 transition-colors">
