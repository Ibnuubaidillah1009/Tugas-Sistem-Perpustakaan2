...
<div class="max-w-4xl mx-auto">
    <div class="bg-white shadow rounded-lg overflow-hidden">
        ...
        <form method="POST" action="{{ route('perpustakawan.users.update', $user) }}" enctype="multipart/form-data" class="p-6 space-y-6">
            @csrf
            @method('PUT')
...
document.getElementById('role').addEventListener('change', toggleNikNisFields);

// Initialize on load
document.addEventListener('DOMContentLoaded', toggleNikNisFields);
</script>
@endsection
